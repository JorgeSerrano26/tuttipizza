<template>
  <section class="src-components-modal-agregar-pizza">
          ...
          <slot name="body">
            ...
            <vue-form :state="formState">
              ...
              <validate tag="div">
                ...
                <input type="text" id="descripcionPizza" name="descripcionPizza"  class="form-control mb-2" v-model.trim="formData.descripcionPizza" required :minlength="descripcionPizzanMinLength" placeholder="Descripción">
